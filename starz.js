/*
    ...
    Manual:
        ...
        // Starz（新增）
        STARZ-Dualsub = type=http-response,pattern=https:\/\/.+starz.com\/.+\.vtt,requires-body=1,max-size=0,timeout=30,script-path=Dualsub.js

        [MITM]
        hostname = *.media.dssott.com, *.media.starott.com, *.api.hbo.com, *.hbomaxcdn.com, *.huluim.com, *.nflxvideo.net, *.cbsaavideo.com, *.cbsivideo.com, *.cloudfront.net, *.akamaihd.net, *.avi-cdn.net, *.youtube.com, *.starz.com
...
if (url.match(/starz.com/)) service = "Starz" // 新增 Starz 识别
